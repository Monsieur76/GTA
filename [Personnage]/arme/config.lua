...
Config.RealWeapons = {
	...
	{name = 'WEAPON_CARBINERIFLE', 		bone = 24818, x = 0.09, y = -0.15, z = 0.1, xRot = 10.0, yRot = 160.0, zRot = 10.0, category = 'assault', 	model = 'w_ar_carbinerifle'},
	...
	{name = 'WEAPON_MUSKET', 			bone = 24818, x = -0.08, y = -0.15, z = 0.0, xRot = 0.0, yRot = 0.0, zRot = 0.0, category = 'shotgun', 	model = 'w_ar_musket'},
	...
	--{name = 'WEAPON_MARKSMANRIFLE', 	bone = 24818, x = 0.1, y = -0.15, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'sniper', 	model = 'w_sr_marksmanrifle'},
 	{name = 'WEAPON_RPG', 				bone = 24818, x = -0.08, y = -0.15, z = 0.0, xRot = 0.0, yRot = 180.0, zRot = 0.0, category = 'heavy', 		model = 'w_lr_rpg'},
}
