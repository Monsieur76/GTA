    ...
    Citizen.CreateThread(function()
        ...
        if FirstSpawn then
            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, clothe)
                if clothe ~= nil then
                    if clothe.bags_1 ~= nil and clothe.bags_1 ~= -1 and clothe.bags_1 ~= 0 then
...
RegisterNetEvent('setDataMaxWeight')
AddEventHandler('setDataMaxWeight', function(sac)
    ESX.SetPlayerData("maxWeight", sac)
end)
