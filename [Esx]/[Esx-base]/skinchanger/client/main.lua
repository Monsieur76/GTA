local Components = {
	...
	{label = _U('makeup_type'),				name = 'makeup_1',			value = 0,		min = -1,	zoomOffset = 0.4,		camOffset = 0.65},
	...
	{label = _U('lipstick_type'),			name = 'lipstick_1',		value = 0,		min = -1,	zoomOffset = 0.4,		camOffset = 0.65},
	...
	{label = _U('blush'),					name = 'blush_1',			value = 0,		min = -1,	zoomOffset = 0.4,		camOffset = 0.65},
...
function ApplySkin(skin, clothes, accessories)
	local playerPed = PlayerPedId()
	...
	if Character['sex'] == 0 then
		SetPedHeadBlendData			(playerPed, Character['dad'], Character['mom'], Character['dad'], Character['skin'], Character['skin'], Character['skin'], face_weight, face_weight, 1.0, true)
	else
		SetPedHeadBlendData			(playerPed, Character['dad'], Character['dad'], Character['mom'], Character['skin'], Character['skin'], Character['skin'], face_weight, face_weight, 1.0, true)
	end
	...
	SetPedHeadOverlay			(playerPed, 3,		Character['age_1'],				Character['age_2'] )			-- Age + opacity
	SetPedHeadOverlay			(playerPed, 0,		Character['blemishes_1'],		Character['blemishes_2'])		-- Blemishes + opacity
	SetPedHeadOverlay			(playerPed, 1,		Character['beard_1'],			Character['beard_2'])			-- Beard + opacity
	SetPedEyeColor				(playerPed,			Character['eye_color'], 0, 1)												-- Eyes color
	SetPedHeadOverlay			(playerPed, 2,		Character['eyebrows_1'],		Character['eyebrows_2'] )		-- Eyebrows + opacity
	SetPedHeadOverlay			(playerPed, 4,		Character['makeup_1'],			Character['makeup_2'])			-- Makeup + opacity
	SetPedHeadOverlay			(playerPed, 8,		Character['lipstick_1'],		Character['lipstick_2'])		-- Lipstick + opacity
	...
	SetPedHeadOverlay			(playerPed, 5,		Character['blush_1'],			Character['blush_2'] )			-- Blush + opacity
	SetPedHeadOverlayColor		(playerPed, 5, 2,	Character['blush_3'])														-- Blush Color
	SetPedHeadOverlay			(playerPed, 6,		Character['complexion_1'],		Character['complexion_2'])		-- Complexion + opacity
	SetPedHeadOverlay			(playerPed, 7,		Character['sun_1'],				Character['sun_2'])			-- Sun Damage + opacity
	SetPedHeadOverlay			(playerPed, 9,		Character['moles_1'],			Character['moles_2'])			-- Moles/Freckles + opacity
	SetPedHeadOverlay			(playerPed, 10,		Character['chest_1'],			Character['chest_2'])			-- Chest Hair + opacity
	SetPedHeadOverlayColor		(playerPed, 10, 1,	Character['chest_3'])														-- Torso Color

	if Character['bodyb_1'] == -1 then
		SetPedHeadOverlay		(playerPed, 11,		255,						Character['bodyb_2'])		-- Body Blemishes + opacity
	else
		SetPedHeadOverlay		(playerPed, 11,		Character['bodyb_1'],		Character['bodyb_2'])
	end

	if Character['bodyb_3'] == -1 then
		SetPedHeadOverlay		(playerPed, 12,		255,							Character['bodyb_4'])
	else
		SetPedHeadOverlay		(playerPed, 12,		Character['bodyb_3'],			Character['bodyb_4'])			-- Blemishes 'added body effect' + opacity
	end
...
AddEventHandler('skinchanger:modelLoaded', function()
	...
	if LoadClothes ~= nil then
		if LoadClothes.accessories ~= nil then
			ApplySkin(LoadClothes.playerSkin, LoadClothes.clothesSkin,LoadClothes.accessories)
			TriggerServerEvent('connexion_player_load')
		else
...
RegisterNetEvent('skinchanger:loadClothesAccesorie')
AddEventHandler('skinchanger:loadClothesAccesorie', function(playerSkin, clothesSkin,accessories)
	if playerSkin['sex'] ~= LastSex then
		LoadClothes = {
			playerSkin	= playerSkin,
			clothesSkin	= clothesSkin,
		...
		ApplySkin(playerSkin, clothesSkin,accessories)
	end
...
AddEventHandler('skinchanger:changeskinfull', function(Character)
	...
	if table.findKey('skin', Character) == false then
		Character['skin'] = 0
	end
