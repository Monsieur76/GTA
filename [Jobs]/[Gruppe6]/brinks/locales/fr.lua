Locales['fr'] = {
  -- zones blip
  ['cloakroom_blip']       = 'Gruppe 6',
  ['vehicleSpawner_blip']  = 'Gruppe 6 : Sortie Véhicule',
  ['vehicleDeleter_blip']  = 'Gruppe 6 : Retour Véhicule',
  ['market_blip']          = 'Gruppe 6 : Superette',
  ['bank_blip']            = 'Gruppe 6 : Banque Centrale',
  ['northBank_blip']       = 'Gruppe 6 : Banque du Nord',
  ['unionDepository_blip'] = 'Gruppe 6 : Incinérateur',
  -- zones action 
  ...
  -- billing menu
  ['billing_title']        = 'Facturation Gruppe 6',
  ...
  ['bad_vehicle']          = 'Vous avez rangé votre ~r~véhicules de service~s~',
