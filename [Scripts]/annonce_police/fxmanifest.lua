...
files {
	...
	'html/assets/images/wealzelbreaking.png',
	'html/assets/images/weazelinfo.png',
	'html/assets/images/weazelPub.png',
	'html/assets/images/weazelAnnonce.png',
	'html/assets/images/wanted.png',
