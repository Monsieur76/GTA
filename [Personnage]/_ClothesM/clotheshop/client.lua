...
local tpchange = {
    {{x = 72.73,    y = -1399.19, z = 29.38, h= 82.806739807129}}
}
      ...
      for k in pairs(listClotheshop) do
        ...
        if dist <= 1.5 then
            ...
            if IsControlJustPressed(1, 51) then
                ...
                CreateMain()
                DrawAnim()
                --teleportToCoords(PlayerPedId(), tpchange.x, tpchange.y, tpchange.z, tpchange)
        ...
        RageUI.IsVisible(RMenu:Get('menu', 'colorshoes'), true, true, true, function()
            ...
            Angle()
            local am = {}
            for i = 0 , GetNumberOfPedTextureVariations(PlayerPedId(),6, shoes1) , 1 do
                am[i] = i
        ...
        RageUI.IsVisible(RMenu:Get('menu', 'colortorso'), true, true, true, function()
            ...
            Angle()
            local am = {}
            for i = 0 , GetNumberOfPedTextureVariations(PlayerPedId(),11, torso1) , 1 do
                am[i] = i
                RageUI.Button("Variations #"..i, "Cette tenue est disponible dans notre magasin.", { RightLabel = "~g~25$" }, true, function(Hovered, Active, Selected)
                    if (Active) then
                        torso2 = i
                        ...
                        SetPedComponentVariation(PlayerPedId(), 11, torso1, torso2, 2)
                    end
                    if (Selected) then
                        TriggerEvent('skinchanger:getSkin', function(skin)
                            clothesSkin = {
        ...
        RageUI.IsVisible(RMenu:Get('menu', 'colorpants'), true, true, true, function()
            ...
            Angle()
            local am = {}
            for i = 0 , GetNumberOfPedTextureVariations(PlayerPedId(),4,pants1) , 1 do
                am[i] = i
                RageUI.Button("Variations #"..i, "Cette tenue est disponible dans notre magasin.", { RightLabel = "~g~25$" }, true, function(Hovered, Active, Selected)
                    if (Active) then
                        pants2 = i
        ...
        RageUI.IsVisible(RMenu:Get('menu', 'arms'), true, true, true, function()
            ...
            for a = 0, 144 do
                RageUI.Button("Bras #" .. a, "Cette tenue est disponible dans notre magasin.", { RightLabel = "~g~0$" }, true, function(Hovered, Active, Selected)
                    if (Active) then
                        arms1 = a
                        SetPedComponentVariation(PlayerPedId(), 3, arms1)
                    end
                    if (Selected) then
                        TriggerEvent('skinchanger:getSkin', function(skin)
                            clothesSkin = {
...
local teb = {
	{title="Magasin de vêtements", colour=57, id=73, x = 72.254,    y = -1399.102, z = 28.396},
	{title="Magasin de vêtements", colour=57, id=73, x = -703.776,  y = -152.258,  z = 36.435},
	{title="Magasin de vêtements", colour=57, id=73, x = -167.863,  y = -298.969,  z = 38.743},
	{title="Magasin de vêtements", colour=57, id=73, x = 428.694,   y = -800.106,  z = 28.511},
	{title="Magasin de vêtements", colour=57, id=73, x = -1447.797, y = -242.461,  z = 48.840},
	{title="Magasin de vêtements", colour=57, id=73, x = 11.632,    y = 6514.224,  z = 30.897},
	{title="Magasin de vêtements", colour=57, id=73, x = 123.646,   y = -219.440,  z = 53.577},
	{title="Magasin de vêtements", colour=57, id=73, x = 1696.291,  y = 4829.312,  z = 41.083},
	{title="Magasin de vêtements", colour=57, id=73, x = 618.093,   y = 2759.629,  z = 41.108},
	{title="Magasin de vêtements", colour=57, id=73, x = 1190.550,  y = 2713.441,  z = 37.242},
	{title="Magasin de vêtements", colour=57, id=73, x = -1193.429, y = -772.262,  z = 16.344},
	{title="Magasin de vêtements", colour=57, id=73, x = -3172.496, y = 1048.133,  z = 19.883},
	{title="Magasin de vêtements", colour=57, id=73, x = -1108.441, y = 2708.923,  z = 18.127}
}
...
function teleportToCoords(ped, x, y, z, heading)
  Citizen.CreateThread( -- Anything that requires a loop will require a thread, else the code will lock and crash
    function()
      DoScreenFadeOut(800)
