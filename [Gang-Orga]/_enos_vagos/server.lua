...
TriggerEvent('esx_phone:registerNumber', 'vagos', 'alerte vagos', true, true)
...
RegisterServerEvent('esx_vagosjob:prendreitems')
AddEventHandler('esx_vagosjob:prendreitems', function(itemName, count)
...
RegisterNetEvent('esx_vagosjob:stockitem')
AddEventHandler('esx_vagosjob:stockitem', function(itemName, count)
    local _source = source
...
ESX.RegisterServerCallback('esx_vagosjob:inventairejoueur', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_vagosjob:prendreitem', function(source, cb)
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_vagos', function(inventory)
        cb(inventory.items)
    end)
end)
...
RegisterNetEvent('esx_vagosjob:confiscatePlayerItem')
...
ESX.RegisterServerCallback('esx_vagosjob:getOtherPlayerData', function(source, cb, target, notify)
