...
function vestiairegouv()
    ...
    while vestigouv do
        RageUI.IsVisible(RMenu:Get('vestiairegouv', 'main'), true, true, true, function()
            ...
            if (Selected) then   
			SetPedComponentVariation(PlayerPedId() , 8, 4, 0) --tshirt 
			SetPedComponentVariation(PlayerPedId() , 11, 27, 0)  --torse
			SetPedComponentVariation(PlayerPedId() , 3, 1, 0)  -- bras
			SetPedComponentVariation(PlayerPedId() , 4, 13, 0)   --pants
			SetPedComponentVariation(PlayerPedId() , 6, 20, 0)   --shoes
