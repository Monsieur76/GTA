...
AddEventHandler('playerSpawned', function()
    ...
    -- Restore position
    if ESX.PlayerData.coords ~= nil then
        SetEntityCoords(playerPed, ESX.PlayerData.coords.x, ESX.PlayerData.coords.y, ESX.PlayerData.coords.z+1)
    end
end)
...
AddEventHandler('esx:addWeapon', function(weapon, ammo,weaponLabel)
...
AddEventHandler('esx:removeWeapon', function(weapon)
    ...
    for key, value in pairs(weapons) do
        if weapon == weapons[key].name then
            table.remove(ESX.PlayerData.loadout,key)
        end
    end
...
AddEventHandler('esx:createMissingPickups', function(missingPickups)
    for pickupId, pickup in pairs(missingPickups) do
        TriggerEvent('esx:createPickup', pickupId, pickup.label, pickup.coords, pickup.type, pickup.name,
