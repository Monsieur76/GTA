Locales['fr'] = {
  ...
  ['ems_clothes_ems'] = 'tenue de service',
  -- Vehicles
  ['ambulance'] = 'L.S.M.S',
  ...
  ['garage_storing'] = 'Votre véhicule se range dans le garage',
  ...
  ['player_not_unconscious'] = 'Cette personne n\'est pas inconscient !',
  ['player_not_conscious'] = 'Cette personne est inconsciente !',
  ['unconscious'] = 'Cette personne n\'est pas dans le coma !',
  -- Boss Menu
  ...
  -- Death
  ['respawn_available_in'] = 'L\'unité X sera appelé dans ~b~%s minutes %s secondes~s~',
