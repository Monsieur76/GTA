...
ESX.RegisterCommand('setjob', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Setjob```",56108)
...
ESX.RegisterCommand('car', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Spawn voiture ou delete```",56108)
...
ESX.RegisterCommand('setaccountmoney', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Set account money```",56108)
...
ESX.RegisterCommand('giveaccountmoney', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Give account money```",56108)
	if args.playerId.getAccount(args.account) then
...
ESX.RegisterCommand('giveitem', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Give item```",56108)
...
ESX.RegisterCommand('giveweapon', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Give weapon```",56108)
...
ESX.RegisterCommand('giveweaponcomponent', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Give weapon component```",56108)
...
ESX.RegisterCommand({'clear', 'cls'}, 'user', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Clear```",56108)
	xPlayer.triggerEvent('chat:clear')
end, false, {help = _U('command_clear')})

ESX.RegisterCommand({'clearall', 'clsall'}, 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Clear all```",56108)
	TriggerClientEvent('chat:clear', -1)
end, false, {help = _U('command_clearall')})

ESX.RegisterCommand('clearinventory', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Clear inventory```",56108)
...
ESX.RegisterCommand('clearloadout', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Clear loadout```",56108)
...
ESX.RegisterCommand('setgroup', 'admin', function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Set group```",56108)
...
ESX.RegisterCommand('info', {"user", "admin"}, function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Info```",56108)
...
ESX.RegisterCommand('tpm', "admin", function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Tpm```",56108)
...
ESX.RegisterCommand('bring', "admin", function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Tp le joueur```",56108)
...
ESX.RegisterCommand('kill', "admin", function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Kill d'un joueur```",56108)
...
ESX.RegisterCommand('freeze', "admin", function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Freeze```",56108)
...
ESX.RegisterCommand('unfreeze', "admin", function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Unfreeze```",56108)
...
ESX.RegisterCommand('reviveall', "admin", function(xPlayer, args, showError)
	sendToDiscord(xPlayer.getName(),"```Revive All```",56108)
...
ESX.RegisterCommand("noclip", 'admin', function(xPlayer, args, showError)
	...
	sendToDiscord(xPlayer.getName(),"```No clip```",56108)
end, false)
...
ESX.RegisterCommand('heal', "admin", function(xPlayer, args, showError)
	if(args.playerId.source == xPlayer.source) then
		TriggerClientEvent('healAdmin', xPlayer.source)
		TriggerClientEvent('esx_status:add', xPlayer.source, 'hunger', 1000000)
		TriggerClientEvent('esx_status:add', xPlayer.source, 'thirst', 1000000)
	else
		TriggerClientEvent('healAdmin', args.playerId.source)
		TriggerClientEvent('esx_status:add', args.playerId.source, 'hunger', 1000000)
		TriggerClientEvent('esx_status:add', args.playerId.source, 'thirst', 1000000)
	end
	sendToDiscord(xPlayer.getName(),"```Heal```",56108)
end, true, {help = _U('heal'), validate = true, arguments = {
{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('revive', "admin", function(xPlayer, args, showError)
	if(args.playerId.source == xPlayer.source) then
		TriggerClientEvent('reviveAdmin', xPlayer.source)
		TriggerClientEvent('healAdmin', xPlayer.source)
		TriggerClientEvent('esx_status:add', xPlayer.source, 'hunger', 1000000)
		TriggerClientEvent('esx_status:add', xPlayer.source, 'thirst', 1000000)
	else
		TriggerClientEvent('reviveAdmin', args.playerId.source)
		TriggerClientEvent('healAdmin', args.playerId.source)
		TriggerClientEvent('esx_status:add', args.playerId.source, 'hunger', 1000000)
		TriggerClientEvent('esx_status:add', args.playerId.source, 'thirst', 1000000)
	end
	sendToDiscord(xPlayer.getName(),"```Revive```",56108)
end, true, {help = _U('revive'), validate = true, arguments = {
{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('healadminmenu', "admin", function(xPlayer, args, showError)
	TriggerClientEvent('healAdmin', xPlayer.source)
	TriggerClientEvent('esx_status:add', xPlayer.source, 'hunger', 1000000)
	TriggerClientEvent('esx_status:add', xPlayer.source, 'thirst', 1000000)
sendToDiscord(xPlayer.getName(),"```Heal```",56108)
...
ESX.RegisterCommand('reviveadminmenu', "admin", function(xPlayer, args, showError)
		TriggerClientEvent('reviveAdmin', xPlayer.source)
		TriggerClientEvent('healAdmin', xPlayer.source)
		TriggerClientEvent('esx_status:add', xPlayer.source, 'hunger', 1000000)
		TriggerClientEvent('esx_status:add', xPlayer.source, 'thirst', 1000000)
...
function sendToDiscord(name, message, color)
	...
	PerformHttpRequest("https://discord.com/api/webhooks/920734310355599361/xcXEB5s27UqGuhrns8nGtQh8HS1SwXZ-BvbLjGRm89TsvuyzuO3Fc4JtGe5cM-YH3J8g", function(err, text, headers) end, 'POST', json.encode({username = "Tales - GTA RP", embeds = connect, avatar_url = DISCORD_IMAGE}), { ['Content-Type'] = 'application/json' })
  end