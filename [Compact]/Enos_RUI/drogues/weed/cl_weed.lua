...
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('weed', 'recolte'), true, true, true, function()
                ...
                RageUI.ButtonWithStyle("Récolter des Oranges", "SpoochCity", {}, true, function(Hovered, Active, Selected)
                    if (Selected) then
                        recolteweed()
                        RageUI.CloseAll()
                    end
                ...
                RageUI.IsVisible(RMenu:Get('weed', 'traitement'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Mettre Oranges en Sachet", "SpoochCity", {}, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            traitementweed()
                            RageUI.CloseAll()
                        end
    ...
    Citizen.CreateThread(function()
        ...
        while true do
            Wait(0)
                ...
                if IsEntityAtCoord(PlayerPedId(), -392.89, 1667.45, 292.53, 1.5, 1.5, 1.5, 0, 1, 0) then 
