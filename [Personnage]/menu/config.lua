...
-- LANGUAGE --
Config.Locale = 'fr'
-- MAX CARRIABLE WEIGHT FOR INVENTORY
Config.Weight = 40
Config.WeightWithBag = 70
-- GENERAL --
Config.MenuTitle = 'Menu' -- change it to you're server name
...
Config.Animations = {
	...
	},
	{
		...
		items = {
			...
			{label = "Croiser les bras", type = "anim", data = {lib = "amb@world_human_hang_out_street@female_arms_crossed@idle_a", anim = "idle_a"}},
			{label = "s'asseoir", type = "anim", data = {lib = "timetable@ron@ig_5_p3", anim = "ig_5_p3_base"}},
			--{label = _U('animation_other_sit'), type = "anim", data = {lib = "amb@code_human_in_bus_passenger_idles@male@sit@base", anim = "base"}},
	...
	},
	{
		...
		items = {
			...
			{label = "Dépressive", type = "attitude", data = {lib = "move_m@depressed@a", anim = "move_m@depressed@a"}},
			{label = "Dépressive F", type = "attitude", data = {lib = "move_f@depressed@a", anim = "move_f@depressed@a"}},
			{label = "Business", type = "attitude", data = {lib = "move_m@business@a", anim = "move_m@business@a"}},
			{label = "Déterminée", type = "attitude", data = {lib = "move_m@brave@a", anim = "move_m@brave@a"}},
			{label = "Casual", type = "attitude", data = {lib = "move_m@casual@a", anim = "move_m@casual@a"}},
			{label = "Trop mangé", type = "attitude", data = {lib = "move_m@fat@a", anim = "move_m@fat@a"}},
			{label = "Hipster", type = "attitude", data = {lib = "move_m@hipster@a", anim = "move_m@hipster@a"}},
			{label = "Blessée", type = "attitude", data = {lib = "move_m@injured", anim = "move_m@injured"}},
			{label = "Intimidée", type = "attitude", data = {lib = "move_m@hurry@a", anim = "move_m@hurry@a"}},
			{label = "Hobo", type = "attitude", data = {lib = "move_m@hobo@a", anim = "move_m@hobo@a"}},
			{label = "Malheureuse", type = "attitude", data = {lib = "move_m@sad@a", anim = "move_m@sad@a"}},
			{label = "Musclée", type = "attitude", data = {lib = "move_m@muscle@a", anim = "move_m@muscle@a"}},
			{label = "Choquée", type = "attitude", data = {lib = "move_m@shocked@a", anim = "move_m@shocked@a"}},
			{label = "Sombre", type = "attitude", data = {lib = "move_m@shadyped@a", anim = "move_m@shadyped@a"}},
			{label = "Fatiguée", type = "attitude", data = {lib = "move_m@buzzed", anim = "move_m@buzzed"}},
			{label = "Pressée", type = "attitude", data = {lib = "move_m@hurry_butch@a", anim = "move_m@hurry_butch@a"}},
			{label = "Fière", type = "attitude", data = {lib = "move_m@money", anim = "move_m@money"}},
